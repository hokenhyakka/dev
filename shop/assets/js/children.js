...
function moveAccessDetails() {
    if (window.innerWidth <= 768) {
        ...
        if (tdElement) {
            ...
            if (!accessDetails) {
                accessDetails = document.createElement("div");
                accessDetails.classList.add("shop-one__access-details");
...
window.addEventListener("resize", moveAccessDetails);
window.addEventListener("DOMContentLoaded", moveAccessDetails);
